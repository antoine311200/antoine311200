...
Hello! My name is Antoine Debouchage. 

I am a PhD student with Barclays and the Laboratoire de Mathématiques et Modélisation d'Évry (LaMME) under a Cifre contract. I graduated with a Master of Engineering from CentraleSupélec (Paris-Saclay University) and a Master of Research (Master MVA) from École normale supérieure Paris-Saclay.

My research interests orbit around probability, statistics, deep learning, financial mathematics, quantitative finance, and quantum computing.
